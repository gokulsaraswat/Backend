const Namez = require('./require_test')

var obj = new Namez(); //There class has a new instance that we created
var returned_val = obj.methodz();
console.log(returned_val);

// Ek file ko 10 jagah use karna that is called- separation of concerns
